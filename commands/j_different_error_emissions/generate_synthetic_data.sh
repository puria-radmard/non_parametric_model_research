...
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data.sh full_von_mises_and_uniform mcmaster2022_e2_dircue_medC gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data.sh est_dim_von_mises_and_uniform mcmaster2022_e2_dircue_medC gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data.sh cue_dim_von_mises_and_uniform mcmaster2022_e2_dircue_medC gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data.sh full_von_mises_and_uniform mcmaster2022_e1_oricue_cue_AR2 gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data.sh est_dim_von_mises_and_uniform mcmaster2022_e1_oricue_cue_AR2 gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data.sh cue_dim_von_mises_and_uniform mcmaster2022_e1_oricue_cue_AR2 gaussian 0
