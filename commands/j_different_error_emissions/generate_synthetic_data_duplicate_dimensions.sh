...
export cmd_path="/homes/pr450/repos/research_projects/error_modelling_torus/non_parametric_model/scripts/synthetic_data_generation/multiple_error_emissions_duplicate_dimensions.py"
...
export synthetic_data_path="/homes/pr450/repos/research_projects/error_modelling_torus/results_link_2025/j_different_error_emissions/synthetic_data_duplicate_dimensions/${data_name}/${model_name}_${variational_parameterisation}_duplicate_dimensions"
