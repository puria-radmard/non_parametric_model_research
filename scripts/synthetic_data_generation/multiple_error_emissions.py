...
data_destination = os.path.join(data_output_path, f'synthetic_data_different_error_emissions.npy')
...
training_yaml_info = {
    ...
    'synthetic_data_code': 'different_error_emissions',
