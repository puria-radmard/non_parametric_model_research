...
export synthetic_data_path="/homes/pr450/repos/research_projects/error_modelling_torus/results_link_2025/j_different_error_emissions/synthetic_data_offset/${data_name}/${model_name}_${variational_parameterisation}_upped"
...
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data_offset.sh est_dim_von_mises_and_uniform mcmaster2022_e2_dircue_medC gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data_offset.sh cue_dim_von_mises_and_uniform mcmaster2022_e2_dircue_medC gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data_offset.sh est_dim_von_mises_and_uniform mcmaster2022_e1_oricue_cue_AR2 gaussian 0
# non_parametric_model/commands/j_different_error_emissions/generate_synthetic_data_offset.sh cue_dim_von_mises_and_uniform mcmaster2022_e1_oricue_cue_AR2 gaussian 0
