...
# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh cue_dim_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 1 _add-0.5
# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh cue_dim_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 1 _add0.5
# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh cue_dim_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 1 _add-1.0
# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh cue_dim_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 1 _add1.0

# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh full_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 0 _add-0.5
# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh full_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 0 _add0.5
# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh full_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 0 _add-1.0
# non_parametric_model/commands/j_different_error_emissions/train_on_synthetic_data_duplicate_dimensions.sh full_von_mises_and_uniform gaussian cue_dim_von_mises_and_uniform gaussian mcmaster2022_e1_oricue_cue_AR2 0 _add1.0
